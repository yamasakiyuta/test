...
keyid     = "448967d271ba2203c45fbf9abc076335"
# エンドポイントURL
url_japan        = "http://api.gnavi.co.jp/RestSearchAPI/20150630/"
url_foreign      = "http://api.gnavi.co.jp/ForeignRestSearchAPI/20150630/"
url = url_japan
# 緯度・経度、範囲を変数に入れる
...
freeword  = sys.argv[1]
#言語判定
check = is_japanese("aaa")
url = check * url_japan + (1 - check) * url_foreign
